                    ...
                    <thead>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo  $row->current_job?></td>
                                ...
                                <?php if ($_SESSION['is_login'] = true){?>
                                <td><a href="<?php echo base_url('/Adm/editabout') ?>/<?php echo $row->id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="<?php echo base_url('Adm/deleteabout') ?>/<?php echo $row->id ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                </td>
                                <?php }?>
