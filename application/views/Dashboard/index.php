                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Data Home</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $Home ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Data Portofolio</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $Portfolio ?></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Data About</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $About ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Dashboard Page Administrator Website Personal Sayyid Aziz, a
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url('SessLog/logout') ?>">Logout</a>
                </div>
            </div>
        </div>
    </div>
