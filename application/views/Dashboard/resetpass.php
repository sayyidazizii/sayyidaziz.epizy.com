                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <?php echo form_open("Adm/updatepass", array('enctype'=>'multipart/form-data')); ?>
                                <label class="form-label" hidden>Id</label>
                                <input class="form-control" hidden type="text" name="id" value="<?php echo $pass->id_user;?>" required>
                                <label class="form-label">Username</label>
                                <input class="form-control" type="text" name="username" value="<?php echo $pass->username;?>" required>
                                <label class="form-label ">Password baru</label>
                                <input class="form-control mb-3" type="password" name="password" required>
                                <input class="btn btn-primary mb-3" type="submit" name="submit" value="Simpan">
                                <a href="<?php echo base_url('Adm')?> " class="btn btn-secondary mb-3">Batal</a>
