                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <?php echo form_open("Adm/saveskill", array('enctype'=>'multipart/form-data')); ?>
                                <label class="form-label">Skill</label>
                                <input class="form-control" type="text" name="skill"  required>
                                <label class="form-label">Bgcolor</label>
                                <input class="form-control" type="text" name="bgcolor"  required>
                                <input class="btn btn-primary mt-2 mb-3" type="submit" name="submit" value="Simpan">
                                <a href="<?php echo base_url('Adm/skill')?> " class="btn btn-secondary mt-2 mb-3">Batal</a>
                            </form>
                            </div>
                        </div>
                        <!-- /.container-fluid -->
