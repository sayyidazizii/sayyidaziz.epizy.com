                                ...
                                <div class="table-responsive">
                                    <table class="table caption-top">
                                        <div class="caption mb-3">
                                            <a class="btn btn-primary" href="<?php echo base_url('Adm/addsosmed') ?>">Tambah Sosmed</a>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><i class="<?php echo $row->sosmed?>"></i></td>
                                                    <td><?php echo  $row->link ?></td>

                                                    <?php if ($_SESSION['is_login'] = true) { ?>
                                                        <td><a href="<?php echo base_url('/Adm/editsosmed') ?>/<?php echo $row->id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                            <a href="<?php echo base_url('Adm/deletesosmed') ?>/<?php echo $row->id ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                                        </td>
                                                    <?php } ?>
