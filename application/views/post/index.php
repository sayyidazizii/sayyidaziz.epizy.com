                                ...
                                <div class="table-responsive">
                                    <table class="table caption-top">
                                        <div class="caption mb-3">
                                            <a class="btn btn-primary" href="<?php echo base_url('Adm/addpost') ?>">Tambah postingan</a>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <?php if ($_SESSION['is_login'] = true) { ?>
                                                        <td><a href="<?php echo base_url('/Adm/editpost') ?>/<?php echo $row->id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                            <a href="<?php echo base_url('Adm/deletepost') ?>/<?php echo $row->id ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                                        </td>
                                                    <?php } ?>
